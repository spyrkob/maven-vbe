...
import org.jboss.set.maven.release.extension.VBEVersionUpdate;

public class VBEVersionComparator implements Comparator<VBEVersionUpdate> {
    public static final Comparator<VBEVersionUpdate> INSTANCE = new VBEVersionComparator();
    ...
    @Override
    public int compare(VBEVersionUpdate v1, VBEVersionUpdate v2) {
